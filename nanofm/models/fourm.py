...
class FourM(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.encoder = TransformerTrunk(
                ...
                head_dim=head_dim,
                mlp_ratio=mlp_ratio,
                use_bias=use_bias # TODO: Define the Transformer encoder trunk
            )
        self.decoder = TransformerDecoderTrunk(
                ...
                head_dim=head_dim,
                mlp_ratio=mlp_ratio,
                use_bias=use_bias # TODO: Define the Transformer decoder trunk
            )
    ...
    def generate_one_modality_roar(
        ...
        start_idx = 0
        for k in schedule:
            positions = all_positions[start_idx:start_idx+k].unsqueeze(0)  
