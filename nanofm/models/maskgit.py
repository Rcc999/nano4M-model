...
class MaskGIT(nn.Module):
    ...
    def __init__(
        ...
        self.to_logits = nn.Linear(dim, vocab_size, False) 
    ...
    def get_maskgit_schedule(self, mask: torch.BoolTensor, num_steps: int = 8) -> List[int]:
        ...
        base_tokens_per_step = total_tokens // num_steps
        remainder = total_tokens % num_steps
        schedule = [base_tokens_per_step] * num_steps
